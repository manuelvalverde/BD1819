...
<?php
    ...
    try
    {
        ...
        $sql = "UPDATE meio SET nome_meio = :nome_meio WHERE num_meio=:num_meio and nome_entidade=:nome_entidade and :num_meio IN (SELECT num_meio FROM meioapoio WHERE nome_entidade = :nome_entidade);";
        echo("<p>$sql</p>");
