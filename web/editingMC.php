...
<?php
    ...
    try
    {
        ...
        $sql = "SELECT num_meio,nome_entidade FROM meiocombate WHERE num_meio=$num_meio and nome_entidade='$nome_entidade';";
        ...
        }else{throw new Exception("The vehicle given is not a Combat vehicle");}
        echo("<p>$sql</p>");
